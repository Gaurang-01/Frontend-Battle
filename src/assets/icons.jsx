/**
 * ICON LIBRARY — Inlined SVG Components
 * All icons are sourced from: src/assets/SVGs-20260626T084751Z-3-001/SVGs/
 *
 * Each component accepts:
 *   size      — number (px). Default: 24
 *   className — string. Tailwind or custom CSS classes
 *   color     — string. CSS color value (applies to stroke & fill where appropriate)
 *   style     — object. Inline style overrides
 *   ...props  — forwarded to the <svg> element (aria-*, data-*, etc.)
 */

// ── arrow-path.svg ────────────────────────────────────────────────────────────
export function IconArrowPath({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
...
export function IconArrowTrendingUp({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ── chart-pie.svg ─────────────────────────────────────────────────────────────
export function IconChartPie({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ── chevron-down.svg ──────────────────────────────────────────────────────────
export function IconChevronDown({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ── chevron-left.svg ──────────────────────────────────────────────────────────
export function IconChevronLeft({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ── chevron-right.svg ─────────────────────────────────────────────────────────
export function IconChevronRight({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ── chevron-up.svg ────────────────────────────────────────────────────────────
export function IconChevronUp({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ── cog-8-tooth.svg ───────────────────────────────────────────────────────────
export function IconCog8Tooth({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ── cube-16-solid.svg ─────────────────────────────────────────────────────────
export function IconCubeSolid({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ── link.svg ──────────────────────────────────────────────────────────────────
export function IconLink({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ── search.svg ────────────────────────────────────────────────────────────────
export function IconSearch({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ── x-mark.svg ────────────────────────────────────────────────────────────────
export function IconXMark({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function IconChevronUpSolid({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// ── link-solid.svg ───────────────────────────────────────────────────────────
export function IconLinkSolid({ size = 24, color = 'currentColor', className = '', style = {}, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
