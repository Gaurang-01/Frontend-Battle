        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-16 pb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-10 mb-14">
            ...
            <div className="col-span-2">
              <a href="#" className="font-mono font-bold text-xl text-arctic mb-1 tracking-wider inline-block hover:opacity-80 transition-opacity">
              ...
              <div className="flex items-center gap-4">
                <a href="https://github.com/Gaurang-01/Frontend-Battle" target="_blank" rel="noopener noreferrer" aria-label="NeuralGrid on GitHub"
                ...
                <a href="https://www.linkedin.com/in/gaurangkhanvilkar/" target="_blank" rel="noopener noreferrer" aria-label="NeuralGrid on LinkedIn"
                  className="text-mint/25 hover:text-mint/60 transition-colors duration-150">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
